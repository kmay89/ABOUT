/* sw.js — the table works on a bus.

   Cache-first over a fixed shell, because none of it changes between
   releases: the whole game is nine scripts, a stylesheet and a page. Bump
   ...
   under somebody mid-hand would lose the hand. */
var VERSION = "euchre-v1";
var SHELL = [
  "./", "./index.html", "./look.css",
  "./cards.js", "./rules.js", "./ai.js", "./coach.js", "./gfx.js",
