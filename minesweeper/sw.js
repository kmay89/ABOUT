/* sw.js — the field works on a bus.

   Cache-first over a fixed shell, because none of it changes between
   releases: the whole game is three scripts, a stylesheet and a page. Bump
   ...
   under somebody mid-field would lose the field. */
var VERSION = "minesweeper-v1";
var SHELL = [
  "./", "./index.html", "./look.css",
  "./core.js", "./gfx.js",
  "./app.js",
